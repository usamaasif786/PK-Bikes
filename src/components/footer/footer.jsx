  ...
  return (
    <footer>
      <div
        ...
        style={{ backgroundColor: "rgb(68, 28, 105)" }}
      >
        <div className="col-11 ">
          <div className="row d-flex justify-content-between align-items-center">
            <div className="col-10 col-md-2 mt-3 mb-3 justify">
              <h4 className="footer-heading mb-4">
                Bikes<span style={{ color: "white" }}>Here</span>
              </h4>
              <p>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste,
                minus. Neque, autem architecto? Officiis sed tenetur
                repudiandae, quasi corporis ducimus animi
              </p>
            </div>
        ...
        <div className="col-11">
          <div className="row">
            <div className="col-12 col-sm d-flex align-items-center">
              <p
                className="justify m-0"
                style={{ fontWeight: "600", color: "gray" }}
              >
                Copyright © {new Date().getFullYear()} www.pakbikes.com
              </p>
            </div>
